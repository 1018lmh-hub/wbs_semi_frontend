// src/features/bookmark/BookmarkList.style.js
...
// ReviewItem의 ItemContainer(카드형)와 동일한 톤 + 클릭 가능함을 hover로 표시
...
// StationDetail의 BookmarkButton과 톤은 같되, 목록에는 이미 즐겨찾기된 것만 있으므로 항상 accent 색.
// hover 시 danger 색으로 바뀌어 "누르면 해제된다"는 것을 암시
